...
parser.add_argument('--data-path', default='/home/minh/Documents/minh/mqsolutions/detec_color/Person-Attribute-Recognition-MarketDuke/dataset', type=str, help='path to the dataset')
parser.add_argument('--dataset', default='market', type=str, help='dataset: market, duke')
parser.add_argument('--backbone', default='densenet121', type=str, help='backbone: resnet50, resnet34, resnet18, densenet121')
...
# ---------
image_datasets = {}
#data_dir = datapath, dataset_name= 'market', 'duke'     , train_val='train'
data_dir = '/home/minh/Documents/minh/mqsolutions/detec_color/Person-Attribute-Recognition-MarketDuke/dataset/Coach/'
dataset_name_train = 'train'
dataset_name_val = 'query'
image_datasets['train'] = Train_Dataset(data_dir, dataset_name=dataset_name_train, train_val='train')
image_datasets['val'] = Train_Dataset(data_dir, dataset_name=dataset_name_val, train_val='query')
...
def load_network(network):
    ...
    save_path = './checkpoints/market/densenet121_nfc/net_last.pth'
