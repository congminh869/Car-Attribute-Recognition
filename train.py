...
parser.add_argument('--backbone', default='resnet34', type=str, help='backbone: resnet50, resnet34, resnet18, densenet121')
...
def load_network(network):
    ...
    save_path = './checkpoints/market_30_9/resnet50_nfc/net_last.pth'
