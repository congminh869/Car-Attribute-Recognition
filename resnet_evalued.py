...
use_id = False
model_name = '{}_nfc_id'.format(backbone) if use_id else '{}_nfc'.format(backbone)
...
save_path = os.path.join('./checkpoints/market_d8m10/resnet50_nfc', 'net_50.pth')
...
#         print(type(pred))
        ...
        if k%1000==0:
            ...
            print(f'{k} :  {t}')
            start = time.time()
            name_save = "./dataset/data_set_minh10/numpy/result_resnet50_2"+str(k)+".npy"
